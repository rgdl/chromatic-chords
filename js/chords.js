...
export const SEVENTH_LINKS = {
    betweenCAndG: [
        [MINOR_7THS['Gb'], HALF_DIMINISHED_7THS['Eb']],
        [MINOR_7THS['Eb'], HALF_DIMINISHED_7THS['Eb']],
        [DOMINANT_FLAT_5THS['A'], HALF_DIMINISHED_7THS['Eb']],

        [MINOR_7THS['A'], HALF_DIMINISHED_7THS['Gb']],
        [MINOR_7THS['Gb'], HALF_DIMINISHED_7THS['Gb']],
        [DOMINANT_FLAT_5THS['C'], HALF_DIMINISHED_7THS['Gb']],

        [MINOR_7THS['C'], HALF_DIMINISHED_7THS['A']],
        [MINOR_7THS['A'], HALF_DIMINISHED_7THS['A']],
        [DOMINANT_FLAT_5THS['A'], HALF_DIMINISHED_7THS['A']],

        [MINOR_7THS['Eb'], HALF_DIMINISHED_7THS['C']],
        [MINOR_7THS['C'], HALF_DIMINISHED_7THS['C']],
        [DOMINANT_FLAT_5THS['C'], HALF_DIMINISHED_7THS['C']],
    ...
    betweenGAndF: [
        [MINOR_7THS['G'], HALF_DIMINISHED_7THS['E']],
        [MINOR_7THS['E'], HALF_DIMINISHED_7THS['E']],
        [DOMINANT_FLAT_5THS['E'], HALF_DIMINISHED_7THS['E']],

        [MINOR_7THS['Bb'], HALF_DIMINISHED_7THS['G']],
        [MINOR_7THS['G'], HALF_DIMINISHED_7THS['G']],
        [DOMINANT_FLAT_5THS['G'], HALF_DIMINISHED_7THS['G']],

        [MINOR_7THS['Db'], HALF_DIMINISHED_7THS['Bb']],
        [MINOR_7THS['Bb'], HALF_DIMINISHED_7THS['Bb']],
        [DOMINANT_FLAT_5THS['E'], HALF_DIMINISHED_7THS['Bb']],

        [MINOR_7THS['E'], HALF_DIMINISHED_7THS['Db']],
        [MINOR_7THS['Db'], HALF_DIMINISHED_7THS['Db']],
        [DOMINANT_FLAT_5THS['G'], HALF_DIMINISHED_7THS['Db']],
    ...
    betweenFAndC: [
        [MINOR_7THS['Ab'], HALF_DIMINISHED_7THS['F']],
        [MINOR_7THS['F'], HALF_DIMINISHED_7THS['F']],
        [DOMINANT_FLAT_5THS['F'], HALF_DIMINISHED_7THS['F']],

        [MINOR_7THS['B'], HALF_DIMINISHED_7THS['Ab']],
        [MINOR_7THS['Ab'], HALF_DIMINISHED_7THS['Ab']],
        [DOMINANT_FLAT_5THS['D'], HALF_DIMINISHED_7THS['Ab']],

        [MINOR_7THS['D'], HALF_DIMINISHED_7THS['B']],
        [MINOR_7THS['B'], HALF_DIMINISHED_7THS['B']],
        [DOMINANT_FLAT_5THS['F'], HALF_DIMINISHED_7THS['B']],

        [MINOR_7THS['F'], HALF_DIMINISHED_7THS['D']],
        [MINOR_7THS['D'], HALF_DIMINISHED_7THS['D']],
        [DOMINANT_FLAT_5THS['D'], HALF_DIMINISHED_7THS['D']],
